...
def documents():
    ...
    line_to_be_removed = Line(
        "Footnote", (100, 100, 200, 200), 10.0, "test", []
    )
...
def test_extract_footnotes_with_ml(documents):
    # set necessary args
    args_dict: dict = {
        "footnote_overlap_threshold": 0.8
    }
    args = argparse.Namespace(**args_dict)
    
    # get a module instance
    module_cls = BaseRunner.by_name("extract_footnotes_with_ml")
